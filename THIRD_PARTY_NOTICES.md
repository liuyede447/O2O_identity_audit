...
The separately staged checkpoints are author-trained artifacts based on the Ultralytics model implementation. All authors and the relevant institutional rights holder approved their public distribution as v3.2.0 release assets under AGPL-3.0-only.
